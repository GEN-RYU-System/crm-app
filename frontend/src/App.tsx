...
import { canAccessNavigationItem, hasNavigationPermission, NAVIGATION_BY_ID, visibleNavigationItems, type NavigationPermissions } from './app/navigation';
