...
function AppRouter() {
  ...
  const quoteNewCreateRoute = canAccessQuotes ? <QuoteCreatePage /> : <Navigate to={NAVIGATION_BY_ID.dashboard.hash} replace />;
  ...
  const hubExtraRoutes: Partial<Record<NavigationItemId, ReactNode[]>> = {
    ...
    quotes: [
      ...
      <Route key="new-create" path={QUOTE_ROUTE_SEGMENTS.create} element={quoteNewCreateRoute} />,
