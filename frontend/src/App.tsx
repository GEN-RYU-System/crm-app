...
function AppRouter() {
  ...
  const quoteCreateRoute = canAccessQuotes && canAddQuotes ? <QuoteCreatePage /> : <Navigate to={canAccessQuotes ? NAVIGATION_BY_ID.quotes.hash : NAVIGATION_BY_ID.dashboard.hash} replace />;
