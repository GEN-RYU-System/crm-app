...
export type InboxKarteDto = { customerName: string; company: string; platform: string; status: string; nextAction: string; note: string; leadType: string; dealResult: string; issue: string; competitorComparison: string; email: string; phone: string; country: string; englishCallName: string; responseSpeed: string; nextActionDate: string; handledTitle: string; salesChannel: string; customerType: string; dealNote: string; monthlyExpectedAmount: string; messageUrl: string };
