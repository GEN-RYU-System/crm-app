...
export type InboxKarteDto = { customerName: string; company: string; platform: string; status: string; nextAction: string; note: string; leadType: string; dealResult: string; issue: string; competitorComparison: string; email: string; phone: string; country: string };
