...
export const quotesCopy = {
  ...
  editor: {
    ...
    shippingFeeCalc: {
      ...
      skipReasonConditionUnitNotApplicable: 'コンディションの単位が適用外です',
      skipReasonProductPackageNotFound: '商品の荷姿設定がありません',
      skipReasonPackageIdNotSet: '荷姿IDが未設定です',
      skipReasonPackageNotFound: '荷姿が見つかりません',
      skipReasonSizeNotFound: 'サイズが見つかりません',
      skipReasonWeightNotFound: '重量が見つかりません',
      skipReasonUnknown: '不明な理由でスキップされました',
      carrierErrorZoneNotFound: '配送先ゾーンが見つかりません',
      carrierErrorWeightExceedsMax: '最大重量 (68 kg) を超過しています',
