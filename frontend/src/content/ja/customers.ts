export const customersCopy = {
  ...
  customerTypes: { company: '法人', individual: '個人' },
  countries: { JP: '日本', US: 'アメリカ', GB: 'イギリス' },
  statuses: { active: '有効', inactive: '停止中', pending: '確認中' },
  shippingLabels: { primary: '主配送先', secondary: '予備配送先' },
  paymentLabels: { primary: '主支払情報', secondary: '予備支払情報' },
  paymentMethods: { card: 'カード', transfer: '振込', invoice: '請求書' },
