...
export const salesOrdersCopy = {
  ...
  detail: {
    ...
    // 発送明細
    shipmentLinesTitle: '発送明細',
    shipmentLinesEmpty: '明細なし',
    shipmentLinesAdd: '明細を追加',
    colSlLineNumber: '行番号',
    colSlProductName: '商品名',
    colSlItem: '品目',
    colSlHtsCode: 'HTSコード',
    colSlMaterial: '素材',
    colSlOriginCountry: '原産国',
    colSlQuantity: '数量',
    shipmentLineFormProductLabel: '商品',
    shipmentLineFormItemLabel: '品目',
    shipmentLineFormHtsCodeLabel: 'HTSコード',
    shipmentLineFormMaterialLabel: '素材',
    shipmentLineFormOriginCountryLabel: '原産国',
    shipmentLineFormQuantityLabel: '数量',
    shipmentLineFormSaveToMasterLabel: '商品マスタにも保存',
    shipmentLineFormSave: '保存',
    shipmentLineFormCancel: 'キャンセル',
    shipmentLineFormSaving: '保存中...',
    shipmentLineFormSaveError: '明細の保存に失敗しました。',
    shipmentLineFormLoadingMasters: 'マスタデータを読み込んでいます...',
    // 請求情報タブ 送料概算（明細ベース）
