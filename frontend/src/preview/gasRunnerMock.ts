...
function buildChain(onSuccess: SuccessHandler, onError: ErrorHandler) {
  ...
  const chain = {
    ...
    getCoreOrdersBatchForFrontend(_s: string | null, _force: boolean) {
      succeed({
        orders: [
          ...
          {
            orderId: 'ORD-00003',
            customerName: 'Preview Customer C',
            invoiceNumber: 'INV-00003',
            invoiceIssuedAt: '2026-01-20',
            paymentMethod: 'WISE',
            invoiceTotal: '8000',
            currency: 'USD',
            paymentDueAt: '2026-03-01',
            paymentStatus: 'PAID',
            invoiceTotalJpy: '1200000',
            status: 'preview-awaiting-shipping',
            paymentConfirmedAt: '2026-01-25',
            shippingCountry: 'US',
            shippingCountryJa: 'United States',
            shipmentStage: 'LABELING',
          },
          {
            orderId: 'ORD-00004',
            customerName: 'Preview Customer D',
            invoiceNumber: 'INV-00004',
            invoiceIssuedAt: '2026-02-01',
            paymentMethod: 'PAYPAL',
            invoiceTotal: '3000',
            currency: 'USD',
            paymentDueAt: '2026-03-10',
            paymentStatus: 'UNPAID',
            invoiceTotalJpy: '450000',
            status: 'preview-awaiting-shipping',
            paymentConfirmedAt: '',
            shippingCountry: 'JP',
            shippingCountryJa: 'Japan',
            shipmentStage: 'AWAITING_PICKUP',
          },
          {
            orderId: 'ORD-00005',
            customerName: 'Preview Customer E',
            invoiceNumber: 'INV-00005',
            invoiceIssuedAt: '2026-02-10',
            paymentMethod: 'WISE',
            invoiceTotal: '12000',
            currency: 'USD',
            paymentDueAt: '2026-04-01',
            paymentStatus: 'PAID',
            invoiceTotalJpy: '1800000',
            status: 'preview-awaiting-shipping',
            paymentConfirmedAt: '2026-02-15',
            shippingCountry: 'US',
            shippingCountryJa: 'United States',
          ...
          {
            orderId: 'ORD-00006',
            customerName: 'Preview Customer F',
            invoiceNumber: 'INV-00006',
            invoiceIssuedAt: '2026-02-20',
            paymentMethod: 'PAYPAL',
            invoiceTotal: '6000',
            currency: 'USD',
            paymentDueAt: '2026-04-10',
            paymentStatus: 'PAID',
            invoiceTotalJpy: '900000',
            status: 'preview-awaiting-shipping',
          ...
          {
            orderId: 'ORD-00007',
            customerName: 'Preview Customer G',
            invoiceNumber: 'INV-00007',
            invoiceIssuedAt: '2026-03-01',
            paymentMethod: 'WISE',
            invoiceTotal: '4000',
            currency: 'USD',
            paymentDueAt: '2026-04-20',
            paymentStatus: 'PAID',
            invoiceTotalJpy: '600000',
            status: 'preview-awaiting-shipping',
            paymentConfirmedAt: '2026-03-05',
            shippingCountry: 'US',
            shippingCountryJa: 'United States',
            shipmentStage: 'DONE',
          },
    ...
    generateElogiCsvForFrontend(_s: string | null, shipmentId: string) {
      ...
      const row = `ebay,${shipmentId},2026/09/04,SKU-001,,サンプル商品,1,10.00,,テスト受取人,,+000-000-0000,,United States,,New York,10001,123 Main St,,,1234.56,Japan,,, `;
      succeed({
        csv: `${header}\n${row}`,
        warnings: [
