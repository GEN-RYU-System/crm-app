...
| DataTable | 表データの表示と列見出し | standalone, embedded / central or start header / sortable or static header / row click / loading Skeleton | Lead list, Component catalog | 整備済み |
