...
const DEV_ORDER_DATE_AMOUNT_AUDIT_ORDER_ID_HEADER = 'order_id';
const DEV_ORDER_DATE_AMOUNT_AUDIT_STATUS_HEADER = 'status';
const DEV_ORDER_DATE_AMOUNT_AUDIT_ORDER_DATE_HEADER = 'order_date';
// 既存コードの受注日補完処理が明示する唯一の補完元。
const DEV_ORDER_DATE_AMOUNT_AUDIT_DATE_CANDIDATE_HEADERS = ['invoice_issued_at'];
