const CORE_SCHEMA_V1_TABLES = {
  ...
  CUSTOMERS: {
    ...
    headers: createCoreSchemaV1Headers([['CUSTOMER_ID', '顧客ID'], ['SOURCE_LEAD_ID', '源流リードID'], ['CUSTOMER_NAME', '顧客名'], ['COUNTRY', '国'], ['EMAIL', 'メール'], ['PHONE', '電話番号'], ['COUNTRY_CODE', '国番号'], ['FIRST_TRANSACTION_DATE', '初回取引日'], ['REGISTERED_AT', '登録日'], ['SALES_ASSIGNEE_ID', 'sales_assignee_id'], ['CONTACT_TOOL', '連絡ツール'], ['FEDEX_ID', 'fedex_id'], ['SHIPPING_NOTE', '発送時メモ'], ['CUSTOMER_SCALE', '顧客規模']]),
  ...
  LOGIN_SESSIONS: {
    ...
    headers: createCoreSchemaV1Headers([['SESSION_ID', 'session_id'], ['STAFF_ID', 'staff_id'], ['ISSUED_AT', 'issued_at'], ['LAST_USED_AT', 'last_used_at'], ['EXPIRES_AT', 'expires_at'], ['STATUS', 'status']]), primaryKey: 'SESSION_ID',
    values: {
      STATUS: {
        ACTIVE:  '有効',
        EXPIRED: '期限切れ',
