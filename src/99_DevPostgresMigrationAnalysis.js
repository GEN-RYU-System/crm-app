...
function devPostgresMigrationAnalysisStage1() {
  ...
  var fkDefs = [
    ...
    { refSheet: '見積もり明細',   refCol: '見積書ID',              targetSheet: '見積もり管理', targetCol: '見積書ID' },
    ...
    { refSheet: '発送',           refCol: 'オーダーID',            targetSheet: 'オーダー管理', targetCol: 'オーダーID' },
