...
const DEV_ORDER_INVOICE_SCHEMA_AUDIT_SHEETS = [
  ...
  { name: 'オーダー管理', requiredHeaders: ['order_id', 'invoice_number', 'customer_id', 'shipping_destination_id', 'payment_destination_id', 'source_lead_id'] },
  { name: 'オーダー明細', requiredHeaders: ['order_line_id', 'order_id', 'product_id'] },
